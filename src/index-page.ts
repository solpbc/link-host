...
// `/` — bare host page. Renders when someone types `link.solpbc.org` into
// a browser directly. Structural, not promotional. CMO-owned copy slots.
// Strict CSP; no analytics, no cookies, no third-party scripts.

const H1 = "link.solpbc.org";
const BODY =
